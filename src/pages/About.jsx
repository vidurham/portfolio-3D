  ...
  return (
    <section className='max-container'>
      ...
      <div className='mt-5 flex flex-col gap-3 text-slate-500'>
        <p>
        As a passionate and highly skilled Software Engineer from Ohio, I bring a robust background in AR/VR techniques and a diverse skill set encompassing 3D animation, neural networks, and full-stack development. My academic achievements include a Master's degree in Computer Science and a Graduate Certificate in Autonomous Systems from the University of Dayton, where I maintained a perfect 4.0 GPA. Through hands-on experience in projects such as the Flyer Pitch competition and the Kaggle Big Data Bowl, I have honed my abilities in complex problem-solving and innovative thinking.
        </p>
        <p>
